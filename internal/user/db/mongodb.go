...
func NewMongoRepository(database *mongo.Database, collection string, logger *logging.Logger) user.Repository {
	return &db{
...
func (d *db) Create(ctx context.Context, user *user.UserModel) error {
...
func (d *db) FindFriend(ctx context.Context, id string) (ufriends []*user.UserModel, err error) {
