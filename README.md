...
1. Создание пользователя, пример запроса:
...
2. Создание друзей, пример запроса:
...
3. Удаление пользователя, пример запроса:
...
4. Возвращение всех друзей пользователя:
...
5. Обновление возраста пользователя, пример запроса:
